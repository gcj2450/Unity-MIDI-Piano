...
namespace util
{
    public class CommonParams
    {
        ...
        // 作为公共数据存储类
        private string _scoreName = "Assets/miso.music-xml-aquarium/Materials/MusicXml/青蛙和蜜蜂.xml";
        private string _xmlFolderPath = "Assets/miso.music-xml-aquarium/Materials/MusicXml";
