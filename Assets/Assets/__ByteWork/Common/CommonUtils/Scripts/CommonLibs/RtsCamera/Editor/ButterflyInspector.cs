...
//        RtsCamera bf = (RtsCamera)target;

//        bf.MinBounds = EditorGUILayout.Vector3Field("Zone size", bf.MinBounds);
...
//        Bounds zone = new Bounds(bf.transform.position, bf.MinBounds);
